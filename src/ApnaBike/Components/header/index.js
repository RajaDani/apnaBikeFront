                ...
                <div className="header-content">
                    <div className="row">
                        ...
                        <div className="col-lg-7 d-lg-block d-none">
                            <nav>
                                <ul>
                                    <li><Link className="navLink " to="/home" title="">Home</Link></li>
                        ...
                        {user ? <div className="col-lg-2 userName userLarge">
                            <span className="far fa-user" id="Popover1" onClick={() => togglePopover()} >
                                <Popover placement="bottom" className='popover' isOpen={popover} target="Popover1" toggle={() => togglePopover()} style={{ marginTop: '10px', backgroundColor: '#f7f7f7' }}>
                                    <PopoverHeader className='popoverHeader'><i className="fas fa-user p-2" ></i><h4>{user}</h4></PopoverHeader>
                                    <PopoverBody className='popoverBody'>
                                        ...
                                        <Link to={"/UserPanel/" + localStorage.getItem('userId')}><Button className="btn btn-success mt-2 p-2 mb-1" style={{ width: '100%', borderRadius: '30px' }}>My Account</Button></Link>
                                    </PopoverBody>
                                </Popover>
                            </span>
                            <h4>{user}</h4>
                        ...
                        <div className="col-md-2 col-sm-2 col-2">
                            {user ? <div className="col-lg-2 userName d-block d-lg-none userSmall">
                                <span className="far fa-user" id="PopoverS" onClick={() => togglePopoverSmall()} >
                                    <Popover placement="bottom" className='popover' isOpen={popoverSmall} target="PopoverS" toggle={() => togglePopoverSmall()} style={{ marginTop: '10px', backgroundColor: '#f7f7f7' }}>
                                        <PopoverHeader className='popoverHeaderSmall'><i className="fas fa-user p-2" ></i><h4>{user}</h4></PopoverHeader>
