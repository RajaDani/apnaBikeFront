...
export default function WhyApnaBike() {
  ...
  return (
    <div
      className="container p-4 mt-3 mb-4 "
      data-aos="zoom-in"
      data-aos-once="true"
    >
      <span>
      ...
      <Row className="whyusCard mt-4 pb-3">
        <Col md="4">
          <div>
            ...
            <p>
              ...
              ApnaBike will always be safe and reliable. We also offer helmets
              on-demand.
            </p>
          </div>
          ...
          <div className="mt-5 ">
            ...
            <p>
              Your local ApnaBike Station is here to make ensure your
              two-wheeler experience is flawless. At your neighborhood station,
              you get to pick any bike, get maintenance, sanitized, and a lot
              more.
            </p>
          </div>
        </Col>
        <Col md="4">
          <img
            src={process.env.PUBLIC_URL + "/images/whyusgirl.png"}
            className="mb-5"
          ></img>
        </Col>
        <Col md="4">
          <div>
            ...
            <p>
              With your trusty ApnaBike app, you can choose any bike, make
              instant payments, get offers, and manage all aspect of your ONN
              experience right from the comfort and ease of your mobile app.
            </p>
          </div>
          ...
          <div className="mt-5 pt-4">
            ...
            <p>
              ...
              down-payments, EMIs and paperwork. Now choose bikes on easy hourly
              and daily plans.
            </p>
          </div>
        </Col>
