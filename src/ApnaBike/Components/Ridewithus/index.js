...
export default function RideWithus() {
    ...
    return (
        <div className="container rideWithus mt-2 p-5 " data-aos="zoom-out" data-aos-once="true">
            <span><img src="/howworks.svg"></img></span>
            <h2 className="headerWork mt-5">Flexibility, Agility & <br></br>
                Freedom to go Anywhere, Anytime</h2>
            <p>Look at available scooters & Bikes for you</p>

            <Row className="rideSection p-5 mt-3">
                <Col sm="12" lg="6">
                    <img src="rideImg.jpg"></img>
                </Col>
                <Col sm="12" lg="6">
