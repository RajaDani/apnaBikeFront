    ...
    const renderBikes = () => {
        ...
        return <div className="row ">
            ...
            {bikes.slice(6, 7).map((bike) => {
                return <div className="col-lg-4 col-md-6 mb-5 " id="loadMore" key={bike.bike_id}>
                    <div className="individualBike">
                        <div className="bikeImgDiv mb-3">
                            <img className="bikeImg" src='./bgi.jpg' alt="" />
                        </div>
                    ...
                    <div class="overlay">
                        <Link to="/pricing"> <div className="text">View More</div></Link>
                        <Link to="/pricing"><span className="fas fa-plus icon"></span></Link>
                    </div>
                </div>
            })}
