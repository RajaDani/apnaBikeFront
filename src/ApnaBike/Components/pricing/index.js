...
function Pricing() {
    ...
    let noOfDays = Math.floor(((Date.parse(sessionStorage.getItem('dropoff')) - Date.parse(sessionStorage.getItem('pickup'))) / 86400000) + 1);
    ...
    const toggleBookOrder = (e) => {
        ...
        if (!sessionStorage.getItem('pickup') || !sessionStorage.getItem('dropoff') || !sessionStorage.getItem('city') === null) {
    ...
    const renderBikes = () => {
        ...
        return <div className="row pricingComponent" >
            {
                bikes.map(bike =>
