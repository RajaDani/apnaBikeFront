      ...
      <div className="container mt-5">
        <Row className="whyusComp" data-aos="zoom-out" data-aos-once="true">
          <Col md="4" className="p-5">
            <div className="whyusImgDiv">
              <img src={process.env.PUBLIC_URL + "/images/ab1.png"}></img>
            </div>
            <div>
              <h4>Designed For The Modern World</h4>
              <p>
                Labore tempore usmod sed incididunt labore et dolore magna
          ...
          <Col md="4" className="p-5">
            <div className="whyusImgDiv">
              <img src={process.env.PUBLIC_URL + "/images/ab2.png"}></img>
            </div>
            <div>
          ...
          <Col md="4" className="p-5">
            <div className="whyusImgDiv">
              <img src={process.env.PUBLIC_URL + "/images/ab3.png"}></img>
            </div>
            <div>
      ...
      <div className="container p-5" data-aos="zoom-in-up" data-aos-once="true">
        ...
        <Row className="ideaContainer">
          <Col md="6" className="p-5">
            <img
              src={process.env.PUBLIC_URL + "/images/idea.jpg"}
              alt="ideaImg"
            ></img>
          </Col>
