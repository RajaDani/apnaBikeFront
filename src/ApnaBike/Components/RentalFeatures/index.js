...
export default function RentalFeatures() {
  ...
  return (
    <>
      ...
      <div
        className="container features mt-5 mb-5 pt-5"
        data-aos="flip-right"
        data-aos-once="true"
      >
        <Row className="pb-5">
          <Col md="6">
            <Row>
              <Col sm="12">
                <h1>
                  ApnaBike - The company to offer the best bike rental services
                  in Pakistan
                </h1>
              </Col>
              <Col sm="12">
                <img
                  className="leftImg mt-5"
                  src={process.env.PUBLIC_URL + "/images/feature2.jpg"}
                  alt="feature"
                ></img>
              </Col>
            </Row>
