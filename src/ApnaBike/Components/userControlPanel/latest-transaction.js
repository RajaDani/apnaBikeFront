...
const LatestTransaction = () => {
  ...
  async function getLatestBookings() {
    let bookings = await fetch(
      BaseUrl + `client/dashboard/getLatestTransactions?userId=${userId}`,
      {
        method: "GET",
        headers: {
                    ...
                    <tbody>
                      {bookings.map((booking) => (
                        <tr key={booking.booked_bikes_id}>
                          ...
                          <td
                            id={"userId" + booking.booked_bikes_id}
                            class="pt-3-half"
                            contenteditable="true"
                          >
                            {booking.user_id}
                          ...
                          <td
                            id={"payment_status" + booking.booked_bikes_id}
                            class="pt-3-half"
                            contenteditable="true"
                          >
