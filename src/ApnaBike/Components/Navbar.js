import { Navbar, NavbarBrand, NavItem, NavLink, Button, Form, Nav } from 'reactstrap';
import './navbar.css';
            ...
            <div>
                <Navbar expand="md" light className="container">
                    ...
                    <div class="collapse navbar-collapse " id="navbarSupportedContent">
                                ...
                                <DropdownMenu className="dropMenu mt-3">
                                    <Dropdown isOpen={brandsOpen} toggle={toggle3} >
                                        <DropdownToggle className='dropdownBtn list-group-item'>
                                            Popular Brands <span className="fas fa-angle-right"></span>
                                        </DropdownToggle>
                                        <DropdownMenu className="dropMenu mt-3">
                                            <DropdownItem className="list-group-item" style={{ marginTop: '-10px' }}>70cc Bikes</DropdownItem>
                                            <DropdownItem className="list-group-item">100cc Bikes</DropdownItem>
                                            <DropdownItem className="list-group-item">125cc Bikes</DropdownItem>
                                            <DropdownItem className="list-group-item">200cc Bikes</DropdownItem>
                                        </DropdownMenu>

                                    </Dropdown>
                                    <DropdownItem className="list-group-item">Latest Bikes</DropdownItem>
                                    <DropdownItem className="list-group-item">Upcoming Bikes</DropdownItem>
                                    <DropdownItem className="list-group-item">Electric Bikes&nbsp;<span class="badge bg-secondary">New</span></DropdownItem>
                                    <DropdownItem className="list-group-item">Service Center</DropdownItem>
                        ...
                        <Button className='signinBtn' outline>Signin</Button>
                        <Button><span className="fab fa-wpforms"></span>&nbsp;Feedback</Button>
                    </div>
                </Navbar>
            </div>
        </>
